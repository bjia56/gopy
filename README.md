...
[![GoDoc](https://godoc.org/github.com/bjia56/gopy?status.svg)](https://godoc.org/github.com/bjia56/gopy)
[![CI](https://github.com/bjia56/gopy/workflows/CI/badge.svg)](https://github.com/bjia56/gopy/actions)
...
See the [CONTRIBUTING](https://github.com/bjia56/gopy/blob/master/CONTRIBUTE.md) guide for pointers on how to contribute to `gopy`.
...
Documentation is available on [godoc](https://godoc.org):
 https://godoc.org/github.com/bjia56/gopy
...
ex:
 ...
 $ gopy pkg github.com/bjia56/gopy/_examples/hi
...
Options:
  ...
  -url="https://github.com/bjia56/gopy": home page for project
...
ex:
 ...
 $ gopy exe github.com/bjia56/gopy/_examples/hi
...
ex:
 ...
 $ gopy gen github.com/bjia56/gopy/_examples/hi
...
ex:
 ...
 $ gopy build github.com/bjia56/gopy/_examples/hi
...
$ go get github.com/bjia56/gopy/_examples/hi
$ gopy build -output=out -vm=python3 github.com/bjia56/gopy/_examples/hi
$ ls out
...
```python
>>> import gopy
>>> hi = gopy.load("github.com/bjia56/gopy/_examples/hi")
gopy> inferring package name...
gopy> loading 'github.com/bjia56/gopy/_examples/hi'...
gopy> importing 'github.com/bjia56/gopy/_examples/hi'

>>> print hi
<module 'github.com/bjia56/gopy/_examples/hi' from '/some/path/.../hi.so'>
...
```
$ cd github.com/bjia56/gopy/_examples/hi
...
```
$ cd $GOPATH/src/github.com/bjia56/gopy
...
[Support matrix ](https://github.com/bjia56/gopy/blob/master/SUPPORT_MATRIX.md).
