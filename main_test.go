...
func TestGoPyErrors(t *testing.T) {
	...
	contains := `--- Processing package: github.com/bjia56/gopy/_examples/gopyerrors ---
ignoring python incompatible function: .func github.com/bjia56/gopy/_examples/gopyerrors.NotErrorMany() (int, int): func() (int, int): gopy: second result value must be of type error: func() (int, int)
ignoring python incompatible method: gopyerrors.func (*github.com/bjia56/gopy/_examples/gopyerrors.Struct).NotErrorMany() (int, string): func() (int, string): gopy: second result value must be of type error: func() (int, string)
ignoring python incompatible method: gopyerrors.func (*github.com/bjia56/gopy/_examples/gopyerrors.Struct).TooMany() (int, int, string): func() (int, int, string): gopy: too many results to return: func() (int, int, string)
ignoring python incompatible function: .func github.com/bjia56/gopy/_examples/gopyerrors.TooMany() (int, int, string): func() (int, int, string): gopy: too many results to return: func() (int, int, string)
`
...
require github.com/bjia56/gopy v0.0.0
replace github.com/bjia56/gopy => %s
`
